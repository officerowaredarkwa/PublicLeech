...
if __name__ == "__main__" :
    ...
    incoming_message_handler = MessageHandler(
        incoming_message_f,
        filters=Filters.command(["leech@Catenacio_bot"]) & Filters.chat(chats="@TORRENTLEECHJOTDOTCOM")
    )
    ...
    incoming_youtube_dl_handler = MessageHandler(
        ...
        filters=Filters.command(["ytdl@Catenacio_bot"]) & Filters.chat(chats="@TORRENTLEECHJOTDOTCOM")
    )
    app.add_handler(incoming_youtube_dl_handler)
    #
    status_message_handler = MessageHandler(
        status_message_f,
        filters=Filters.command(["status@Catenacio_bot"]) & Filters.chat(chats="@TORRENTLEECHJOTDOTCOM")
    )
